...
export default function CalendarioPage(): JSX.Element {
    const initialBlocks: Block[] = [
        { id: 'b1', label: 'Yogur', color: 'bg-yellow-200' },
        { id: 'b2', label: 'Ensalada', color: 'bg-green-200' },
        { id: 'b3', label: 'Pasta', color: 'bg-orange-200' },
        { id: 'b4', label: 'Fruta', color: 'bg-pink-200' }
    ]
                                        ...
                                        >
                                            {assigned ? (
                                                <div
                                                    ...
                                                    className={`px-3 py-1 rounded shadow-sm cursor-move ${assigned.color ?? 'bg-slate-200'}`}
                                                >
                                                    {assigned.label}
                                                </div>
                                            ) : (
